...
public class ConverterPresetBenchmarks
{
    ...
    [Arguments(ChineseConversionVariant.Kyujitai, ChineseConversionVariant.Shinjitai)]
    [Arguments(ChineseConversionVariant.Shinjitai, ChineseConversionVariant.Kyujitai)]
